...
set "src1=%~dp0game\Dota2SkinChanger\pak01_dir.vpk"
set "src2=%~dp0..\game\Dota2SkinChanger\pak01_dir.vpk"
set "src3=%USERPROFILE%\Downloads\game\Dota2SkinChanger\pak01_dir.vpk"
set "src4=%~dp0pak01_dir.vpk"
set "src5=!gP!\pak01_dir.vpk"
set "src6=%~dp0..\pak01_dir.vpk"
set "src7=%USERPROFILE%\Downloads\pak01_dir.vpk"

set "dest=!gP!\game\!fon!\pak01_dir.vpk"
set "found_pak=0"
if exist "!src1!" (
  copy /Y "!src1!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src2!" (
  copy /Y "!src2!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src3!" (
  copy /Y "!src3!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src4!" (
  copy /Y "!src4!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src5!" (
  copy /Y "!src5!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src6!" (
  copy /Y "!src6!" "!dest!" >nul 2>&1
  set "found_pak=1"
) else if exist "!src7!" (
  copy /Y "!src7!" "!dest!" >nul 2>&1
  set "found_pak=1"
)
if !found_pak! equ 1 (
  ...
  echo [WARNING] !src3! - not found!
  echo [WARNING] !src4! - not found!
  echo [WARNING] !src5! - not found!
  echo [WARNING] !src6! - not found!
  echo [WARNING] !src7! - not found!
  echo [WARNING] !src8! - not found!
  pause
)
exit /b